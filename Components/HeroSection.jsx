                ...
                <div className="container mx-auto px-4 py-24 relative z-10">
                    <div className="max-w-2xl">
                        ...
                        <p className="text-xl text-white/90 mb-8">
                            Discover the ideal rental that matches your lifestyle, budget, and
                        ...
                        <div className="bg-white rounded-xl shadow-xl p-6">
                            <div className="flex flex-col space-y-4">
                                ...
                                <div className="flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-3">
                                    <button className="w-full sm:w-auto bg-primary text-white px-6 py-3 !rounded-button whitespace-nowrap hover:bg-primary/90 transition flex items-center justify-center">
                                        <i className="ri-search-line mr-2"></i>
                                        Search Properties
                                    </button>

                                    <button className="w-full sm:w-auto border border-gray-300 bg-white text-gray-700 px-6 py-3 !rounded-button whitespace-nowrap hover:bg-gray-50 transition flex items-center justify-center">
                                        <i className="ri-equalizer-line mr-2"></i>
                                        Advanced Filters
                                    </button>

                                    <button className="w-full sm:w-auto bg-secondary text-white px-6 py-3 !rounded-button whitespace-nowrap hover:bg-secondary/90 transition flex items-center justify-center">
